...
mod tests {
    ...
    fn assert_ident_parses_tag<'a>(arena: &'a Bump, ident: &str) {
        assert_ident_parses(arena, ident, Ident::Tag(ident));
    }
    fn assert_ident_parses_opaque<'a>(arena: &'a Bump, ident: &str) {
        assert_ident_parses(arena, ident, Ident::OpaqueRef(ident));
    }
    fn assert_ident_parses_simple_access<'a>(arena: &'a Bump, ident: &str) {
        assert_ident_parses(
            arena,
            ident,
            Ident::Access {
    ...
    fn assert_ident_parses_malformed<'a>(arena: &'a Bump, ident: &str, pos: Position) {
        assert_ident_parses(
            arena,
            ident,
